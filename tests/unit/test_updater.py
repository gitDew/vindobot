...
def test_diff_and_new():
    students = [
            ...
            {"StammNr": "20000", "FirstName": "Janos", "LastName": "Pal", 
                "RoomNr": "777", "BlockedTill": "0000-00-00 00:00:00"},
            {"StammNr": "123460", "FirstName": "Bunci", "LastName": "Marrone", 
                "RoomNr": "666", "BlockedTill": "0000-00-00 00:00:00"}
            ]
    ...
    entries = [
            ...
            {"RowID": 102, "StammNr":"123460", "FirstName": "Jane", "LastName": "Marrone", "RoomNr": "120", "BlockedTill": "0000-00-00 00:00:00", "From":"", "To":"", "Comment": ""}
            ]
...
def test_diff():
    ...
    entries = [
            {"RowID": 100, "StammNr":"123456", "FirstName": "John", "LastName": "Serious", "RoomNr": "999", "BlockedTill": "2021-12-31 00:00:00", "From":"01.01.2022", "To":"01.02.2022", "Comment": "Serious guy"},
            {"RowID": 101, "StammNr":"20000", "FirstName": "Janos", "LastName": "Pal", "RoomNr": "777", "BlockedTill": "0000-00-00 00:00:00", "From":"", "To":"", "Comment": "literally the pope"},
            {"RowID": 102, "StammNr":"123460", "FirstName": "Jane", "LastName": "Marrone", "RoomNr": "120", "BlockedTill": "0000-00-00 00:00:00", "From":"", "To":"", "Comment": ""}
            ]
